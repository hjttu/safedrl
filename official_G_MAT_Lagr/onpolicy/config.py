...
def get_config():
    ...
    parser.add_argument("--use_cbf_guide", type=lambda x: bool(strtobool(x)), default=False)
    parser.add_argument("--cbf_edge_feature_dim", type=int, default=11)
    parser.add_argument("--cbf_k1", type=float, default=2.0)
    parser.add_argument("--cbf_k2", type=float, default=2.0)
    parser.add_argument("--d_safe_agent", type=float, default=0.25)
    parser.add_argument("--d_safe_obstacle", type=float, default=0.30)
    parser.add_argument("--slack_penalty_base", type=float, default=100.0)
    parser.add_argument("--slack_penalty_priority", type=float, default=500.0)
    parser.add_argument("--beta_min", type=float, default=0.2)
    parser.add_argument("--beta_max", type=float, default=0.95)
    parser.add_argument("--memory_reset_steps", type=int, default=20)
    parser.add_argument("--memory_reset_h", type=float, default=1.0)
    parser.add_argument("--lambda_int", type=float, default=0.0)
    parser.add_argument("--lambda_trm", type=float, default=0.0)
    parser.add_argument("--guide_alpha_init", type=float, default=1.0)
    parser.add_argument("--guide_alpha_final", type=float, default=0.0)
    parser.add_argument("--guide_decay_ratio", type=float, default=0.6)
    parser.add_argument("--guide_tau", type=float, default=0.5)
    parser.add_argument("--cbf_beta_init", type=float, default=0.02)
    parser.add_argument("--cbf_beta_final", type=float, default=0.5)
    parser.add_argument("--cbf_warmup_ratio", type=float, default=0.2)
    parser.add_argument("--hard_mask_start_ratio", type=float, default=0.7)
    parser.add_argument("--h_keep_init", type=float, default=-0.05)
    parser.add_argument("--h_keep_final", type=float, default=0.05)
    parser.add_argument("--semi_hard_mask", type=lambda x: bool(strtobool(x)), default=True)
    parser.add_argument("--hard_phi_margin", type=float, default=0.3)
    parser.add_argument("--cbf_action_accel_scale", type=float, default=1.0)
    parser.add_argument("--min_valid_action_ratio_init", type=float, default=0.7)
    parser.add_argument("--min_valid_action_ratio_final", type=float, default=0.3)
    parser.add_argument("--guide_fallback_topk", type=int, default=5)
    parser.add_argument("--lambda_guide_init", type=float, default=0.03)
    parser.add_argument("--guide_loss_decay_ratio", type=float, default=0.4)
    ...
    parser.add_argument("--deadlock_K", type=int, default=20)
