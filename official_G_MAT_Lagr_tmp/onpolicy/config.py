...
def get_config():
    ...
    parser.add_argument("--safety_score_coef", type=float, default=0.5,
                        help="graph safety-score bias applied before the hard mask")
    parser.add_argument("--safety_rank_loss_coef", type=float, default=0.1,
                        help="MSE coefficient for ranking safe actions by analytical margin")
    parser.add_argument("--guide_loss_coef", type=float, default=0.2,
