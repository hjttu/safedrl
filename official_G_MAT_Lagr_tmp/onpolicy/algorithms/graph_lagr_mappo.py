...
class GS_MAPPO():
    ...
    def __init__(self, 
        ...
        self.guide_loss_coef = args.guide_loss_coef
        self.safety_rank_loss_coef = args.safety_rank_loss_coef
    ...
    def ppo_update(self, 
        ...
        values, action_log_probs, dist_entropy, cost_values, guide_loss, safety_rank_loss = self.policy.evaluate_actions(
            share_obs_batch,
            obs_batch,
            node_obs_batch,
            adj_batch,
        ...
        policy_loss = (
            policy_action_loss
            + self.guide_loss_coef * self.policy.actor.guide_weight * guide_loss
            + self.safety_rank_loss_coef * safety_rank_loss
        )
        ...
        return (value_loss, critic_grad_norm, policy_loss, dist_entropy,
                ...
                aver_episode_costs, cost_adv_targ, adv_targ, guide_loss,
                safety_rank_loss)
    ...
    def train(self, 
        ...
        for _ in range(self.ppo_epoch):
            ...
            for sample in data_generator:
                value_loss, critic_grad_norm, policy_loss, dist_entropy, actor_grad_norm, imp_weights, cost_loss, cost_grad_norm, aver_episode_costs, cost_adv_targ, adv_targ, guide_loss, safety_rank_loss = self.ppo_update(sample, update_actor)
                ...
                train_info['safety_rank_loss'] += safety_rank_loss.item()
