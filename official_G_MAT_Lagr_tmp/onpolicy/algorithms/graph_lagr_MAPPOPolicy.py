...
class GS_MAPPOPolicy:
    ...
    def lr_decay(self, episode: int, episodes: int) -> None:
        ...
        update_linear_schedule(
            ...
            epoch=episode,
            total_num_epochs=episodes,
            initial_lr=self.cost_critic_lr,
        )

    def set_training_progress(self, progress: float) -> None:
        self.actor.set_training_progress(progress)
    ...
    def evaluate_actions(
        ...
        """
        action_log_probs, dist_entropy, guide_loss, safety_rank_loss = self.actor.evaluate_actions(
            obs,
            node_obs,
            adj,
            agent_id,
        ...
        return values, action_log_probs, dist_entropy, cost_values, guide_loss, safety_rank_loss
